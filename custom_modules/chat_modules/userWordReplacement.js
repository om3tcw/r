...
const TARGET_USER_WORD_REPLACEMENTS = [
    ...
    { from: "damn",      to: "d***" },
    { from: "hell",      to: "h***" },
    { from: "motherfucker", to: "m***********" },
    { from: "cazzo",     to: "c****" },
    { from: "cazzi",     to: "c****" },
    { from: "vaffanculo", to: "v**********" },
    { from: "vaffa",     to: "v****" },
    { from: "stronzo",   to: "s******" },
    { from: "stronza",   to: "s******" },
    { from: "merda",     to: "m****" },
    { from: "coglione",  to: "c*******" },
    { from: "coglioni",  to: "c*******" },
    { from: "porca puttana", to: "p**** p******" },
    { from: "porca troia",   to: "p**** t****" },
    { from: "figlio di puttana", to: "f***** d* p******" },
    { from: "minchia",   to: "m*****" },
    { from: "che cazzo", to: "c** c****" },
    { from: "testa di cazzo", to: "t**** d* c****" },
    { from: "porco dio", to: "p**** d*" },
    { from: "madonna",   to: "m******" }
];
